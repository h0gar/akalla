	...
	$.fn.lightBox = function(settings) {
		...
		function _set_navigation() {
			...
			if ( settings.activeImage != 0 ) {
				if ( settings.fixedNavigation ) {
					$('#lightbox-nav-btnPrev').addClass('lightbox-nav-btnPrev-show')
						.unbind()
						.bind('click',function() {
					...
					$('#lightbox-nav-btnPrev').unbind().hover(function() {
						$(this).addClass('lightbox-nav-btnPrev-show');
					},function() {
						$(this).removeClass('lightbox-nav-btnPrev-show');
			...
			if ( settings.activeImage != ( settings.imageArray.length -1 ) ) {
				if ( settings.fixedNavigation ) {
					...
					$('#lightbox-nav-btnNext').addClass('lightbox-nav-btnNext-show')
						.unbind()
						.bind('click',function() {
							settings.activeImage = settings.activeImage + 1;
							_set_image_to_view();
					...
					$('#lightbox-nav-btnNext').unbind().hover(function() {
						$(this).addClass('lightbox-nav-btnNext-show');
					},function() {
						$(this).removeClass('lightbox-nav-btnNext-show');
					}).show().bind('click',function() {
						settings.activeImage = settings.activeImage + 1;
						_set_image_to_view();
						return false;
